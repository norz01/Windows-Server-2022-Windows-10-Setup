...
Promosikan sebagai Domain Controller:
...
gpupdate /force
2.4 Mencipta Pengguna & Kumpulan Active Directory
Buka Active Directory Users and Computers dari Tools di Server Manager.
Kembangkan domain test1.com.
Cipta kumpulan (group) baru jika perlu (cth: ftp) dengan klik kanan pada Users > New > Group.
Cipta akaun pengguna berikut dengan klik kanan pada Users > New > User. Pastikan untuk menambah mereka ke kumpulan yang betul.
...
Buka DNS dari menu Tools.
Kembangkan Forward Lookup Zones > test1.com.
Pastikan terdapat rekod hos (A) untuk WINsrvSN yang menunjuk ke 192.168.SN.100.
2.7 Konfigurasi Pelayan FTP
Pasang Peranan IIS & FTP:
...
Tukar Nama Komputer & Sertai Domain:
